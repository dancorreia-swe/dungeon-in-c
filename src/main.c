...
int a, b, c = 1, i, loop = 0, luckloop = 0, jeweloop = 0;
length, columns, rows;                                                                                             // DESIGN
...
void godmodeactivation()
{
  ...
  hability_potion = 1;
  luck_potion = 1, energy_potion = 1, emerald = 1, sapphire = 1, iron_hook = 0, iron_key = 1, wood_tube = 1, rope = 1, metal_bell = 1, brass_bell = 1, chalice = 1, morph_potion = 1, leather_wristband = 1, monkey_amulet = 1, dagger = 1, ruby = 1, topaz = 1, wooden_legs = 1, old_bone = 1, shield = 1, wish_ring = 1, moringa_acid = 1, diamond = 1;
...
void luck_damage2()
{ // Deals luck damage to the 2 monster (2v2 combat)
  printf("\n\033[1;33mVocê deseja testar sua SORTE? (digite \"sim\" ou \"nao\")\n");
  printf("Sua SORTE ATUAL: %d\n\n\033[0;37m", luck);
  while (loop < 1)
  {
...
void defenseTurn1()
{ // Defense Turn Monster 1 (Who attacks is the monster 2)
  printf("A VEZ DOS MONSTROS: DEFENDA-SE!");
  while (defenseloop < 1)
  {
    loop = 0;
